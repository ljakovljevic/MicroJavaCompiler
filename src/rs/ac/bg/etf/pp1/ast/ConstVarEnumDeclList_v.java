...
public class ConstVarEnumDeclList_v extends ConstVarEnumDeclList {

    private ConstVarEnumDeclList ConstVarEnumDeclList;
    private VarDeclList VarDeclList;

    public ConstVarEnumDeclList_v (ConstVarEnumDeclList ConstVarEnumDeclList, VarDeclList VarDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstVarEnumDeclList_v(\n");
