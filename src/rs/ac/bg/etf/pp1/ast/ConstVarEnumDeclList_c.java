...
public class ConstVarEnumDeclList_c extends ConstVarEnumDeclList {

    private ConstVarEnumDeclList ConstVarEnumDeclList;
    private ConstDeclList ConstDeclList;

    public ConstVarEnumDeclList_c (ConstVarEnumDeclList ConstVarEnumDeclList, ConstDeclList ConstDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstVarEnumDeclList_c(\n");
