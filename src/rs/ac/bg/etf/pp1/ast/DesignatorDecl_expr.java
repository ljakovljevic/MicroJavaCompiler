...
public class DesignatorDecl_expr extends DesignatorDecl {

    private ArrayDesignator ArrayDesignator;
    private Expr Expr;

    public DesignatorDecl_expr (ArrayDesignator ArrayDesignator, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorDecl_expr(\n");
